# Modify the previous turtle walk program so that the turtle turns around when it hits the wall or when one turtle
# collides with another turtle (when the positions of the two turtles are closer than some small number).
# Steven Sousa - Exercise 6 - 10/26/2020
...
def isInScreen(w, t1, t2):
    ...
    stillIn = True
    # If any t1 hits screen border, it'll turn around and move forward
    ...
    # If any t2 hits screen border, it'll turn around and move forward
    ...
    # If turtles hit each other, they will turn around and move forward
